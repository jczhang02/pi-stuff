...
- Use one execution owner, task branch and worktree per task. Put worktrees under `.worktrees/<branch-name>`, keep that directory ignored, and check existing ownership before starting. Preserve others' work and stage only task files.
