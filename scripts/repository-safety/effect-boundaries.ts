...
export const EFFECT_BOUNDARY_INVENTORY = {
	...
	transitionCompatibility: [
		...
		{
			contractionTicket: "ps-pby.11",
			path: "packages/pi-stuff/src/web/runtime/gemini-search.ts",
			symbols: ["legacyProviderAvailability", "legacyProviderSearch", "searchWithGemini"],
		},
		{
			contractionTicket: "ps-pby.11",
		...
		{
			contractionTicket: "ps-pby.11",
			path: "packages/pi-stuff/src/web/runtime/utils.ts",
			symbols: ["requestSignal"],
		},
	],
