...
export const EFFECT_BOUNDARY_INVENTORY = {
	governedSources: [
		...
		"packages/pi-stuff/src/fast-resume/controller.ts",
		"packages/pi-stuff/src/fast-resume/effect-owner.ts",
		"packages/pi-stuff/src/fast-resume/index.ts",
		"packages/pi-stuff/src/fast-resume/scanner.ts",
		"packages/pi-stuff/src/fast-resume/session-operations.ts",
		"packages/pi-stuff/src/fast-resume/settings.ts",
	...
	nativeAdapters: [
		"packages/pi-stuff/src/fast-resume/scanner-native.ts",
		"packages/pi-stuff/src/fast-resume/session-operations-native.ts",
		"packages/pi-stuff/src/fast-resume/session-reader-native.ts",
