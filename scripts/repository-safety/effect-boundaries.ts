...
export const EFFECT_BOUNDARY_INVENTORY = {
	...
	transitionCompatibility: [
		...
		{
			contractionTicket: "ps-pby.10",
			path: "packages/pi-stuff/src/web/runtime/brightdata-unlocker.ts",
			symbols: ["extractWithBrightDataUnlocker"],
		},
		{
			contractionTicket: "ps-pby.10",
			path: "packages/pi-stuff/src/web/runtime/firecrawl.ts",
			symbols: ["extractWithFirecrawl"],
		},
		{
			contractionTicket: "ps-pby.11",
			path: "packages/pi-stuff/src/web/runtime/gemini-pdf-extract.ts",
			symbols: ["extractPDFViaGemini"],
		},
		{
			contractionTicket: "ps-pby.11",
			path: "packages/pi-stuff/src/web/runtime/gemini-url-context.ts",
			symbols: ["extractWithGeminiWeb", "extractWithUrlContext"],
		},
		{
			contractionTicket: "ps-pby.10",
			path: "packages/pi-stuff/src/web/runtime/kagi.ts",
			symbols: ["extractWithKagi"],
		},
		{
			contractionTicket: "ps-pby.11",
			path: "packages/pi-stuff/src/web/runtime/ollama.ts",
			symbols: ["extractWithOllama"],
		},
		{
			contractionTicket: "ps-pby.10",
			path: "packages/pi-stuff/src/web/runtime/parallel.ts",
			symbols: ["extractWithParallel"],
		},
		{
			contractionTicket: "ps-pby.10",
			path: "packages/pi-stuff/src/web/runtime/querit.ts",
			symbols: ["extractWithQuerit"],
		},
		{
			contractionTicket: "ps-pby.10",
			path: "packages/pi-stuff/src/web/runtime/search1api.ts",
			symbols: ["extractWithSearch1API"],
		},
		{
			contractionTicket: "ps-pby.11",
			path: "packages/pi-stuff/src/web/runtime/tinyfish.ts",
			symbols: ["extractWithTinyFish"],
		},
	],
