...
export const EFFECT_BOUNDARY_INVENTORY = {
	...
	transitionCompatibility: [
		{
			contractionTicket: "ps-pby.14",
			path: "packages/pi-stuff/src/mcp/runtime/init.ts",
			symbols: ["connectStartupServers", "initializeMcp"],
		},
		{
			contractionTicket: "ps-pby.14",
			path: "packages/pi-stuff/src/mcp/runtime/server-manager.ts",
			symbols: ["close", "closeAll", "connect", "reconnect"],
		},
		{
