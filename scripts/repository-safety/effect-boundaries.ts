...
export const EFFECT_BOUNDARY_INVENTORY = {
	governedSources: [
		...
		"packages/pi-stuff/src/subagents/src/runs/background/background-effect-owner.ts",
	...
	transitionCompatibility: [
		...
		{
			contractionTicket: "ps-pby.20",
			path: "packages/pi-stuff/src/subagents/src/runs/background/writer-process-registry.ts",
			symbols: ["inspectWriterProcessLivenessAsync", "readWriterProcessRegistryAsync"],
		},
		{
			contractionTicket: "ps-pby.21",
			path: "packages/pi-stuff/src/subagents/src/runs/foreground/execution.ts",
			symbols: ["executeForegroundConfig", "recoverForegroundFailure"],
		},
	],
