...
This Capability Package is an owned fork of the MIT-licensed `pi-rtk-optimizer` 0.9.0.
...
Future rebases must update every identity and mirrored checksum above, preserve the upstream MIT notice, and re-run real Host and local RTK certification.
