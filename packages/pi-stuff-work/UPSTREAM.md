...
Pi Stuff Work is an owned, reduced fork of [`pi-background-tasks`](https://github.com/ismailsaleekh/pi-background-tasks), selected from its published `2.0.0` release and exact source commit `db632653682c00852a38c0972a761fb1e9f24dc3`.
...
`pi-patty-bg-tasks@1.1.6` was inspected only as a behavior reference for conditional Bash detachment and Monitor ergonomics. Its source is not mixed into this fork.
