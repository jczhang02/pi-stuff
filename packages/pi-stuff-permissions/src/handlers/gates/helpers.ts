 ...
 */
export function accessFactsFromPath(surface: string, path: AccessPath): ForwardedAccessFacts {
	return {
		surface,
 ...
 */
export function accessFactsFromValue(surface: string, value: string): ForwardedAccessFacts {
