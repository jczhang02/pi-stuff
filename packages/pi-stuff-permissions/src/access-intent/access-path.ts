...
export class AccessPath {
	 ...
	 */
	matchValues(): string[] {
		return this.canonical ? [...new Set([...this.matchAliases, this.canonical])] : [...this.matchAliases];
	}
	 ...
	 */
	static forPath(pathValue: string, options: { cwd: string; resolveBase?: string; flavor: PathFlavor }): AccessPath {
