...
import { type BashTokenShape, classifyWin32BashToken } from "#src/access-intent/bash/msys-bash-tokens";
...
class PlatformPathFlavor implements PathFlavor {
	...
	constructor(
		...
		this.matchOptions = windows ? { caseInsensitive: true, windowsSeparators: true } : undefined;
	}
...
export const posixPathFlavor: PathFlavor = new PlatformPathFlavor(posixPath, false);
export const win32PathFlavor: PathFlavor = new PlatformPathFlavor(winPath, true);
