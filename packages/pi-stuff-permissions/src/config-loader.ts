...
import { type ShellToolsConfig, type UnifiedPermissionConfig, unifiedConfigSchema } from "./config-schema";
 ...
 */
export function normalizeFlatPermissionValue(value: unknown): FlatPermissionConfig | undefined {
 ...
 */
export function validateUnifiedConfig(parsed: unknown): UnifiedConfigLoadResult {
...
export function mergeUnifiedConfigs(
	...
	for (const key of ["debugLog", "permissionReviewLog", "yoloMode", "doublePressToConfirm"] as const) {
