import type { DenyWithReason, FlatPermissionConfig, PatternValue, PermissionState } from "./config-schema";
...
export type { DenyWithReason, FlatPermissionConfig, PatternValue, PermissionState, RuleOrigin };
