...
export function normalizeFilesystemPath(pathValue: string, flavor: PathFlavor): string {
...
export function isSubagentExecutionContext(
	...
	const normalizedSubagentRoot = normalizeFilesystemPath(subagentSessionsDir, flavor);
