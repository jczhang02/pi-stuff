...
This module contains source derived from the pinned `pi-subagents` `0.38.0` snapshot by Nico Bailon.
...
product behavior and UI. Unrelated upstream product surfaces were excluded from the absorbed source.
