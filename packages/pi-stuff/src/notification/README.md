...
Inside tmux, `auto` preserves the selected system-notification protocol and adds one raw BEL so tmux can mark the
window for attention; tmux continues to own the marker's appearance and focus-time clearing.
