...
import piStuffPermissions from "@jczhang02/pi-stuff-permissions";
...
const CAPABILITIES: readonly CapabilityFactory[] = [piStuffUi, piStuffPermissions, piStuffTodo, piStuffBtw];
