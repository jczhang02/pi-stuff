...
[Statusline](docs/statusline.md) adds a two-row footer with native context usage, cache hit, local Git state and existing extension statuses. A global switch restores the native footer.
