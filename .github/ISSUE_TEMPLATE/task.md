---
name: Engineering task / 工程任务
about: Define scoped work with verifiable acceptance criteria / 定义范围明确且验收标准可验证的工作
title: ''
labels: ['needs-triage']
assignees: ''
---
...
- [ ] <!-- Replace with a condition that can be verified. -->

#### 中文

<!-- 翻译上述验收条件，保持含义和完成状态一致。 -->

### Dependencies and related work

<!-- Link prerequisites, related issues, documents, or Beads IDs. Write N/A if none. -->

#### 中文

<!-- 链接前置任务、相关 Issue、文档或 Beads ID。没有则写“无”。 -->
