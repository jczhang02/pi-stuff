...
以英文版为准。面向人的文档须在同一 PR 中成对维护：`README.md` / `README.zh-CN.md`、本指南 / `CONTRIBUTING.md`、`docs/adr/` / `docs/zh-CN/adr/`。两种语言版本须互链，含义保持一致。代理指令和技能仅保留英文，不另建中文代理规则。历史研究资料无需批量翻译。Issue、PR 和公开评论使用英文，对话使用中文。
