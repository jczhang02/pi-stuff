...
| Accepted steering still pending                               | Exact Queued instruction in detail; do not replace the child's execution status                                  |
