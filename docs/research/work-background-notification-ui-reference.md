...
7. **`/tasks` is session-local management, not history.** Successful Agent entries may remain until cleanup; failed/stopped Agents and terminal shell tasks leave; the transcript remains authoritative.
