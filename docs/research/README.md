...
| Question                                                                                            | Evidence                                                               |
| --------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------- |
| [How does /tui default display child blocks and disclosure?](claude-code-default-tui-2026-09-22.md) | 16 fresh runs, 86 states; corrects the multiple-connector evidence gap |
...
The four Claude reports use the official 2.1.261 client with fixed local SSE responses. Tools execute, but model selection is not tested. Other harness and package findings refer to their pinned source revisions. The UI spec lists proposals still awaiting adoption.
