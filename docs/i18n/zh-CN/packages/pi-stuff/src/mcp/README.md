<!-- translation-source: packages/pi-stuff/src/mcp/README.md; translation-source-sha256: 2c11b9e82b694a1df6b23f74e1a99b112e44a08e30396cf101337dc834eda8b8 -->
...
设置使用与其他套件命令对话框相同的连续全宽顶线、两个单元内容边距、粗体标题、`◆` 小节标题、有界列表窗口和独立 Escape 路径。窄布局省略可选预览；低高度布局在次要发现文字之前保留标题、当前选择、确认详情和返回路径。
