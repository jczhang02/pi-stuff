...
The source-size comparison uses the 23-file JS/TS path set from the `35225c57` to working-tree git diff, including new untracked source paths and excluding artifacts: 4,275 physical lines became 5,176 (+901). This is a changed-path comparison, not whole-repository size or a speedup claim.
